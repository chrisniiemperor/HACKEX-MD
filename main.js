...
global.channelLink = "https://whatsapp.com/channel/0029Vb78V290gcfOcvVPzL2w";
global.ytch = "ANONYMOUS-PRIME";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb78V290gcfOcvVPzL2w'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/EPyySgs7I2B1Szpf5v12pk?mode=wwt`
                }, { quoted: message });
                return;
            }
        }
